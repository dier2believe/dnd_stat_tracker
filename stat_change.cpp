...
void statChange(int turnNumber, vector<Entity*> &orderArr) {
    ...
    switch(userInput){
        case 'y':
            /*If health did change, it calls the changeHealth function in the Entity
              class*/
    ...
    switch(userInput){
        case 'y':
            /*If armor did change, it calls the changeHealth function in the Entity
              class*/
    ...
    /*After status changes the function calls the isDeadCheck function to see if 
      the entity has no health and in turn is dead.*/
